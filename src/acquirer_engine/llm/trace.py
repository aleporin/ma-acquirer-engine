"""Write run transcripts and match their recorded responses during replay.

Owns: Trace events, conversation identity, and recovery of recorded failures.
Does not own: Network access, shared-cache lookup, or inventing missing responses.
"""
...
from acquirer_engine.llm.results import PageAttempt, ReviewResult
